                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
                    ...
                    <div className="card" style={{ padding: 24 }}>
                        ...
                        {[
                            ...
                            { label: "Cadastrado em", value: new Date(profile.created_at).toLocaleDateString("pt-BR") },
                            { label: "Última atualização", value: new Date(profile.updated_at).toLocaleDateString("pt-BR") },
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                            {charts.map((c: any) => (
                                <div key={c.id} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "10px 14px", background: "rgba(255,255,255,.03)", borderRadius: 8 }}>
                                    ...
                                    <span style={{ color: "#475569", fontSize: 11 }}>{new Date(c.created_at).toLocaleDateString("pt-BR")}</span>
                                </div>
                            ))}
                        </div>
                    </div>
